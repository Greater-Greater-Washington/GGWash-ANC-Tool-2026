  ...
  function init(rootEl) {
    ...
    Promise.all([
      ...
      function renderCompareView(list) {
        ...
        var endorsedRespondents = respondents.filter(function (c) { return c.endorsed; });
        var html = "";
        if (endorsedRespondents.length) {
          html += '<p class="anc-endorsed-summary"><span class="anc-endorsed-check" aria-hidden="true">\u2713</span> GGWash endorsed ' +
            endorsedRespondents.map(function (c) { return escapeHTML(c.name); }).join(", ") + ".</p>";
        }
        ...
        questionOrder.forEach(function (q) {
          ...
          respondents.forEach(function (c) {
            var val = c.answers[q];
            html += '<div class="anc-compare-candidate"><div class="anc-compare-candidate-name">' + escapeHTML(c.name) +
              (c.endorsed ? ' <span class="anc-endorsed-tag"><span class="anc-endorsed-check" aria-hidden="true">\u2713</span> Endorsed</span>' : "") + "</div>";
      ...
      function renderCandidateCard(c, openByDefault) {
        ...
        if (c.endorsed) {
          card += '<div class="anc-endorsed-ribbon"><span class="anc-endorsed-check" aria-hidden="true">\u2713</span> GGWash endorsed</div>';
